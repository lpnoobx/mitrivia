...
def validar_respuesta(respuesta):
  ...
  while respuesta not in ("a","b","c","d","e"):
    respuesta = input("Debes responder a,b,c,d o e . Ingrese nuevamente tu respuesta : ")
...
def run():
  ...
  while repetir== "si" :
    ...
    print("Hola " +nombre + " responde  las siguientes preguntas escribiendo la letra de la alternativa y presionando 'Enter' para enviar tu respuesta:")
    ...
    print("En total respondio correctamente : "+ correctas + " de 3 preguntas ")
    print("**************************")

    repetir1= input("Ingresa SI para repetir la trivia , sino ingrese cualquier caracter para terminar: ")
